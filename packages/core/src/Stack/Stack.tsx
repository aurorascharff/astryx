...
export function Stack({
  ...
  // Resolve padding to per-axis values: `padding` sets both axes; `paddingX`
  // / `paddingY` take precedence on their own axis when provided.
  ...
  const stylexProps = stylex.props(
    ...
    resolvedPaddingX != null && paddingInlineStyles[resolvedPaddingX],
    resolvedPaddingY != null && paddingBlockStyles[resolvedPaddingY],
